...
public class BusStopTask3 extends Task<List<BusStopInfo>> {
    ...
    protected void running() {
        super.running();
        System.out.println("BusStopTask3: Running...");
    }

    @Override
    protected void succeeded() {
        super.succeeded();
        System.out.println("BusStopTask3: OK");
    }

    @Override
    protected void failed() {
        super.failed();
        System.out.println("BusStopTask3: FAILED!");
    }
}
